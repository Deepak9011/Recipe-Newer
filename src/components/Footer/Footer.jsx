    ...
    <footer>
      <div className='footer-divider'>
        <svg
          ...
          style={{ fill: '#ffffff', width: '100%', height: 60, transform: 'rotate(180deg)' }} >
          <path
      ...
      <div className='footer-elements'>
        ...
        <div id="icons">
          <a className='icon-link' href="https://github.com/Deepak9011" target="_blank">
            <i className="fa-brands fa-github-square fa-2xl"></i>
          </a>
          <a className='icon-link' href="https://www.linkedin.com/in/deepakagrawal90/" target="_blank">
